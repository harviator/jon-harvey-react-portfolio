        ...
        <section id="work">
            ...
            <div class="projects-grid">
                ...
                <div className="project-tile">
                    <img className="project-image" src="./assets/images/super-auction-kart.png"
                ...
                <div className="project-tile">
                    <img className="project-image" src="./assets/images/note-taker.png" alt="Screen Shot of Note Taker" />
                    <p>Note Taker</p>
                ...
                <div className="project-tile">
                    <img className="project-image" src="./assets/images/wx-screen-shot.png"
